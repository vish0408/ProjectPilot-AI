...
export default function Sidebar({ nav, collapsed, setCollapsed }: { nav: typeof STUDENT_NAV; collapsed:boolean; setCollapsed:(v:boolean)=>void }) {
  ...
  const rc: Record<Role,string> = { student:"from-blue-600 to-indigo-600", guide:"from-indigo-600 to-violet-600", collegeadmin:"from-slate-700 to-slate-900", hod:"from-cyan-600 to-blue-700", superadmin:"from-red-600 to-rose-800" };
  const rl: Record<Role,string> = { student:"PhD Scholar", guide:"Research Guide", collegeadmin:"College Admin", hod:"HOD", superadmin:"Super Admin" };
