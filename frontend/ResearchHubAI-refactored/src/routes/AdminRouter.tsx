...
import SuperAdminCollegeAdminManagement from "../pages/admin/SuperAdminCollegeAdminManagement";
...
export default function AdminRouter() {
  ...
  switch(screen) {
    ...
    case "hod-management": return <AdminHodManagement/>;
    case "college-admin-management": return <SuperAdminCollegeAdminManagement/>;
