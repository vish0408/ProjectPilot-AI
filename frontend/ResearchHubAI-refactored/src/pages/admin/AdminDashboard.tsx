...
export default function AdminDashboard() {
  ...
  const activeProjects = data?.researchInProgress ?? null;
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard label="Active Projects" value={activeProjects === null ? "-" : `${activeProjects}`} icon={FlaskConical} color="bg-rose-500"/>
      </div>
