            ...
            <div key={r.id} className="flex items-center justify-between px-5 py-4 border-b border-border last:border-0 hover:bg-muted/40">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => {
                  ...
                  const a = document.createElement("a"); a.href = url; a.download = `${r.title.replace(/\s+/g, "_")}.txt`; a.click();
                  URL.revokeObjectURL(url);
                }} className="p-1.5 rounded-lg hover:bg-muted text-muted-foreground hover:text-foreground" title="Download">
